      ...
      child: ListView(
       ...
       Row(
         ...
         children: [
          ...
          SizedBox(height: 1,),
          textfield('Infosys Pvt. Ltd'),
          SizedBox(height: 10,),
          textfield('Company Mail ID'),
          SizedBox(height: 1,),
          textfield('Password'),
          SizedBox(height: 1,),
          textfield('Company Location'),
          SizedBox(height: 1,),
          textfield('Short Description about your company'),
